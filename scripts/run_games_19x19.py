...
def addCmds(cmds):
    ...
    #     "--komi 7.5 --size 19 -n 100 -e baseline/komi7.0-w1600b1600-19x19")
    ...
    # "--komi 7.5 --size 19 -sa 99999 -sb 0 -ae -n 50 -e atkexpand/w1600b_atk1600-atkexpand-19x19")

    # # Soft Attack [50, 100, 200, 400, 800, 1200, 1600]

    # for sa in [50, 100, 200, 400, 800, 1200, 1600]:
    #     cmds.append("python3 /goattack/scripts/attack.py -p black -b gtp_black.cfg -w gtp_white.cfg -bp 1600 -wp 1600 -t 1 " +
    #         f"--komi 7.5 --size 19 -sa {sa} -sb 0 -n 50 -e softatk/sa{sa}-w1600b_atk1600-19x19")

    # # Soft Attack + Attack Expansion [0, 50, 100, 200, 400, 800, 1200, 1600]

    # for sa in [0, 50, 100, 200, 400, 800, 1200, 1600]:
    #     cmds.append("python3 /goattack/scripts/attack.py -p black -b gtp_black.cfg -w gtp_white.cfg -bp 1600 -wp 1600 -t 1 " + 
    #         f"--komi 7.5 --size 19 -sa {sa} -sb 0 -ae -n 50 -e softatk_atkexpand/sa{sa}-w1600b_atk1600-atkexpand-19x19")

    # # Soft Attack + Soft Expansion [50, 100, 200, 400]

    # for se in [50, 100, 200, 400]:
    #     cmds.append("python3 /goattack/scripts/attack.py -p black -b gtp_black.cfg -w gtp_white.cfg -bp 1600 -wp 1600 -t 1 " +
    #         f"--komi 7.5 --size 19 -sa 800 -sb 0 -se {se} -ae -n 50 -e softatk_softexpand/sa800-se{se}-w1600b_atk1600-atkexpand-19x19")

    # # MCTS soft backup [50, 100, 200, 400, 800, 1200, 1600]

    # for sb in [50, 100, 200, 400, 800, 1200, 1600]:
    #     cmds.append("python3 /goattack/scripts/attack.py -p black -b gtp_black.cfg -w gtp_white.cfg -bp 1600 -wp 1600 -t 1 " + 
    #         f"--komi 7.5 --size 19 -sa 0 -sb {sb} -n 50 -e mctssb/mctssb{sb}-w1600b_atk1600-19x19")
    ...
    # for sb in [50, 100, 200, 400, 800, 1200, 1600]:
    #     cmds.append("python3 /goattack/scripts/attack.py -p black -b gtp_black.cfg -w gtp_white.cfg -bp 1600 -wp 1600 -t 1 " + 
    #         f"--komi 7.5 --size 19 -sa 0 -sb {sb} -ms -n 50 -e minimaxsb/minimaxsb{sb}-w1600b_atk1600-19x19")
    ...
    # for sb in [50, 100, 200, 400, 800, 1200, 1600]:
    #     cmds.append("python3 /goattack/scripts/attack.py -p black -b gtp_black.cfg -w gtp_white.cfg -bp 1600 -wp 1600 -t 1 "
    #         f"--komi 7.5 --size 19 -sa 0 -sb {sb} -ae -n 50 -e mctssb_atkexpand/mctssb{sb}-w1600b_atk1600-atkexpand-19x19")
    ...
    # for sb in [50, 100, 200, 400, 800, 1200, 1600]:
    #     cmds.append("python3 /goattack/scripts/attack.py -p black -b gtp_black.cfg -w gtp_white.cfg -bp 1600 -wp 1600 -t 1 " + 
    #         f"--komi 7.5 --size 19 -sa 0 -sb {sb} -ms -ae -n 50 -e minimaxsb_atkexpand/minimaxsb{sb}-w1600b_atk1600-atkexpand-19x19")
    ...
    #     f"--komi 7.5 --size 19 -sa 0 -sb 0 -se 25 -ae -n 50 -e test/test-soft-expand")
